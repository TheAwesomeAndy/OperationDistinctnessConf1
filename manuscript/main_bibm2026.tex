...
This paper studies a binned spiking reservoir encoding for affective ERP signal analysis. Each ERP observation is mapped through a fixed leaky integrate-and-fire (LIF) reservoir, summarized by six post-onset spike-count bins, and compressed into a reservoir embedding (Fig.~\ref{fig:reservoir_dynamics}). The resulting representation is evaluated using subject-grouped validation and perturbation diagnostics. The contribution is threefold:
\begin{enumerate}
