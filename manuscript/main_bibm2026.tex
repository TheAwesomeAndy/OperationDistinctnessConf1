...
\caption{Representation-level perturbation response. Balanced accuracy (mean, 95\% CI) for the ERP-window and band-power baselines and the reservoir embedding under clean, $5$~dB amplitude-noise, and $30\%$ channel-dropout conditions. The ERP-window baseline leads on clean data but degrades most; the reservoir embedding shows the smallest absolute degradation, narrowing the gap under controlled corruption. Dashed line = chance.}
