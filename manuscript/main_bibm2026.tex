...
\begin{enumerate}
    \item A subject-grouped robustness characterization of affective-ERP representations under amplitude noise and channel dropout, with per-fold confidence intervals and a permutation null (Sec.~\ref{sec:clean}, Tables~\ref{tab:clean}--\ref{tab:dropconf}).
